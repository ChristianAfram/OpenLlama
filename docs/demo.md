# The 90-second OpenLlama thesis demo

This is the demo that *is* OpenLlama's pitch: a mutating action is gated by a
...
> the commands below. No model or network required — `openllama exec` runs a
...
$ openllama exec write_file --json '{"path":"feature.txt","content":"new feature code\n"}'
